...
class  Example(APIView):
    def get(sefl, request):
        ...
        client = pymongo.MongoClient("mongodb://anamika:1234@cluster0-t3qae.mongodb.net/test?retryWrites=true")
        db = client.test
        #client.find_one()
        ...
        return Response({"datafromdatabase": client.find_one()},status=status.HTTP_200_OK)
